...
// so array should be [5,4,3,2,1,0]   depending on the number I pick
// and then you need to do console.log(arr.length);



// function addArr(number){
// var newCD = [];
// if (number > 0){
//     for (var i = number; i; 0 ){
//         for (var i = number; i >= 0; number = number -1 ){
//             newCD.push(i);
//         }
//     }
//     return newCD;
// }
// console.log(addArr(8));
// }
